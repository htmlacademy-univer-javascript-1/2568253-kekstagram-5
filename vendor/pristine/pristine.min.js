!function(e,r){
  ...
  const e = {en:{required:'This field is required',email:'This field requires a valid e-mail address',number:'This field requires a number',integer:'This field requires an integer value',url:'This field requires a valid website URL',tel:'This field requires a valid telephone number',maxlength:'This fields length must be < ${1}',minlength:'This fields length must be > ${1}',min:'Minimum value for this field is ${1}',max:'Maximum value for this field is ${1}',pattern:'Please match the requested format',equals:'The two fields do not match',default:'Please enter a correct value'}};function r(e){
    ...
    const f = this;function c(e,r,t,n){
      ...
      for(var n = [],i = !0,s = 0;t.validators[s];s++){
        const a = t.validators[s],l = t.params[a.name] ? t.params[a.name] : [];if(l[0] = t.input.value,!a.fn.apply(t.input,l) && (i = !1,'function' === typeof a.msg ? n.push(a.msg(t.input.value,l)) : 'string' === typeof a.msg ? n.push(r.apply(a.msg,l)) : a.msg === Object(a.msg) && a.msg[o] ? n.push(r.apply(a.msg[o],l)) : t.messages[o] && t.messages[o][a.name] ? n.push(r.apply(t.messages[o][a.name],l)) : e[o] && e[o][a.name] ? n.push(r.apply(e[o][a.name],l)) : n.push(r.apply(e[o].default,l)),!0 === a.halt)){
          break;
        }
      }return t.errors = n,i;
    }function m(e){
      ...
      const r = m(e),t = r[0],n = r[1],i = e.input,s = `error-${ i.id || Math.floor((new Date).valueOf() * Math.random())}`;t && (t.classList.remove(f.config.successClass),t.classList.add(f.config.errorClass),i.setAttribute('aria-describedby',s),i.setAttribute('aria-invalid','true')),n && (n.setAttribute('id',s),n.setAttribute('role','alert'),n.innerHTML = e.errors.join('<br/>'),n.style.display = n.pristineDisplay || '');
    }function h(e){
      const r = function(e){
        const r = m(e),t = r[0],n = r[1],i = e.input;return t && (t.classList.remove(f.config.errorClass),t.classList.remove(f.config.successClass),i.removeAttribute('aria-describedby'),i.removeAttribute('aria-invalid')),n && (n.removeAttribute('id'),n.removeAttribute('role'),n.innerHTML = '',n.style.display = 'none'),r;
